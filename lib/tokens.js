              ...
              if (!err) {
                ...
                if (isCCTX) {
                  ...
                  if (contractScript.indexOf('OP_RETURN ') > -1) {
                    ...
                    var delimByte = ['0e', '0f', '0c', '1e', '06', '08', '09', '10', '11', '12', '13', '14'];
                    ...
                    for (var z = 0; z < delimByte.length; z++) {
                      try {
                        if (contractScript.indexOf(delimByte[z]) > -1) {
                          ...
                          if (contractName && contractDesc && contractSupply) {
                    ...
                    if (isCCTransfer) {
                      if (!isCCOnChainDexOrder &&
                        ...
                        if (self.cache.tokens[ccId].transactionsIndex[sender].indexOf(txid) === -1) {
                          ...
                          console.log('update mempool tx', self.cache.tokens[ccId].transactions[sender][self.cache.tokens[ccId].transactionsIndex[sender].indexOf(txid)]);
                        }
                        ...
                        if (sender !== receiver[0]) {
                          if (self.cache.tokens[ccId].transactionsIndex[receiver[0]].indexOf(txid) === -1) {
                            ...
                            console.log('update mempool tx', self.cache.tokens[ccId].transactions[receiver[0]][self.cache.tokens[ccId].transactionsIndex[receiver[0]].indexOf(txid)]);
                          }
                        }
                      } else {
                        console.log('CC token onchain exchange ' + ccId);
